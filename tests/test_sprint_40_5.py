"""Tests for Sprint 40.5 USDT currency parsing."""
...
class TestUsdtCurrencyParsing:
    @pytest.mark.parametrize(
        ...
        [
            ("101000 USDT", 101_000, "USDT"),
            ("101000 usdt", 101_000, "USDT"),
            ("101k usdt", 101_000, "USDT"),
            ("101.5k USDT", 101_500, "USDT"),
            (EXAMPLE_LINE, 101_000, "USDT"),
        ],
    )
    def test_usdt_parses_as_usdt(
        self,
        line: str,
        expected_price: int,
    ...
    def test_ustd_typo_parses_as_usdt(self) -> None:
